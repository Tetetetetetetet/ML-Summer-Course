...
# 文件路径
train_path = 'Dataset/processed/train_processed/network_train.csv'
test_path = 'Dataset/processed/train_processed/network_test.csv'
feature_json_path = 'config/feature.json'
train_output_path = 'Dataset/processed/train_processed/one_hot_network_train.csv'
test_output_path = 'Dataset/processed/train_processed/one_hot_network_test.csv'
